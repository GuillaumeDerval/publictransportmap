...
from Program.dynamic_Inc_APSP.Data_structure_reversible import Distance
...
class travellers_modelisation:
    ...
    def __init__(self, travel_path: str, distance_oracle: Distance, reducing_factor: int, mymap=mapmap, stop_list_path=PATH.STOP_POSITION_LAMBERT):
        self.map = mymap
